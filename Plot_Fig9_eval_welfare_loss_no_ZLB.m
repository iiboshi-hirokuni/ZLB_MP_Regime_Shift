...
switch model
 ...
 case 'Taylor_pf' 
    ...
    load('./output/Taylor_pf.mat', 'PF1_y_Taylor_pf');
     load('./output/Taylor_pf.mat', 'PF1_i_Taylor_pf');
     load('./output/Taylor_pf.mat', 'PF1_pi_Taylor_pf');
...
%      end
  ...
  case 'Taylor_stc_no_switch' 
      ...
      load('./output/Taylor_stc_no_switch.mat', 'PF_y_Taylor_stc');
     load('./output/Taylor_stc_no_switch.mat', 'PF_i_Taylor_stc');
     load('./output/Taylor_stc_no_switch.mat', 'PF_pi_Taylor_stc');         
     load('./output/Taylor_stc_no_switch.mat', 'Taylor_stc_u');
     load('./output/Taylor_stc_no_switch.mat', 'Taylor_stc_g');
     ...
     case 'Taylor_pf_no_switch' 
      ...
      load('./output/Taylor_pf_no_switch.mat', 'PF_y_Taylor_pf');
     load('./output/Taylor_pf_no_switch.mat', 'PF_i_Taylor_pf');
     load('./output/Taylor_pf_no_switch.mat', 'PF_pi_Taylor_pf');         
     load('./output/Taylor_pf_no_switch.mat', 'Taylor_pf_u');
     load('./output/Taylor_pf_no_switch.mat', 'Taylor_pf_g');
...
for j = 2:nsim
  ...
  pi_sim(j) = interp2(u, g, PF_pi, u_sim(j), g_sim(j), 'linear')*100;
...
for j = 2:nsim
  ...
  pi1_sim(j) = interp2(u1, g1, PF1_pi, u1_sim(j), g1_sim(j), 'linear')*100;
